...
class Scanner():
    ...
    def pause(self):
        ...
        if proceed:
            ...
            proceed = None
        self.status.set("Rotating... {}% Paused".format(int((stepCount / totalSteps) * 100)))
    ...
    def reset(self):
        ...
        self.status.set("Rotating... {}% Reset".format(int((stepCount / totalSteps) * 100)))
    ...
    def scan(self):
        ...
        if stepCount < totalSteps:
            stepperClient.step()
            stepCount += 1
            self.status.set("Rotating... {}%".format(int((stepCount / totalSteps) * 100)))
            self.progress.set(stepCount)
            ...
            self.status.set("Rotating... Complete")
    ...
    def sendEmail(self):
        ...
        self.root.update_idletasks()
        link = s3Client.uploadFile("scan.ply", "groupbcreol", self.fileName.get() + ".ply")
